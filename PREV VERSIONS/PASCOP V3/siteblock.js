...
function theBlocking() {
	...
	if(semanticParse("") > 0 || semanticParse("twitter") > 0 || semanticParse("facebook") > 0 || semanticParse("instagram") > 0 || semanticParse("whatsapp") > 0 || semanticParse("youtube") > 0 || semanticParse("fashion") > 2 || semanticParse("sports") > 3 || semanticParse("pirated") > 2 || semanticParse("pirate") > 2 || semanticParse("game") > 3 || semanticParse("torrent") > 2 || semanticParse("music") > 3 || semanticParse("porn") > 3 || semanticParse("jizz") > 3 || semanticParse("fuck") > 10 || semanticParse("sex") > 10) {
		// if we detected porn...
...
function blockAccess() { 
	...
	var platformBase = "https://accessedwebsite38493.com/";
